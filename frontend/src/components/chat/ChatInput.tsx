...
export const ChatInput: React.FC<ChatInputProps> = ({
    ...
    return (
        <div className="bg-white/80 backdrop-blur-lg border-t border-gray-200/50 p-3 pb-6 safe-area-pb">
            <div className="max-w-4xl mx-auto flex items-end gap-2">
                <button
                    type="button"
                    onClick={onToggleRecording}
                    disabled={!recordSupported || isLoading}
                    className={`p-3 rounded-2xl transition-all duration-300 flex-shrink-0 ${isRecording
                ...
                >
                    ...
                    <button
                        ...
                        className={`mr-2 mb-2 p-2 rounded-xl transition-all duration-300 ${input.trim() && !isLoading
